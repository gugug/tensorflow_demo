...
def load_data_label():
    ...
    X_train, y_train = build_emotion_feature('../essay_data/vocab1_train.txt', emotion_dict)
    X_test, y_test = build_emotion_feature('../essay_data/vocab1_test.txt', emotion_dict)
