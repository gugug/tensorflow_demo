...
if __name__ == '__main__':
    ...
    train_path = os.path.join(base_dir, 'area_train.csv')
    test_path = os.path.join(base_dir, 'area_test.csv')
    valid_path = os.path.join(base_dir, 'area_valid.csv')

    user_predict = user_predict(train_path, test_path, valid_path)
